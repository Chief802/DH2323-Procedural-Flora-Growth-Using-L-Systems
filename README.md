...
This is done by investigating the efficacy generating a wide array of unique instances of flora in real-time using efficient construction 
...
L-Systems have generally not seen much deployment for real-time rendering. The output of a plant generated by an L-System can quickly balloon into hundreds of thousands of individual segments, 
each requiring aspects such as mesh geometry, correct surface normals, and UV coordinates. Additionally, the great variety expexted in a natural environment requires either an impractically large library of pre-authored assets, 
or a generation and rendering algorithm that can produce variation deterministically and efficiently at runtime.  

These limitations are the primary motivators for this project.
